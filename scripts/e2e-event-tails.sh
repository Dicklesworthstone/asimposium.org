...
suite="e2e-event-tails"
reproduce="bash scripts/e2e-event-tails.sh"
...
e2e_emit_and_optionally_record "$write_artifacts" "$run_id" "$suite" "$started_ms" "pass" "EVENT_TAILS_E2E_COMPLETE" "$reproduce"
exit 0
