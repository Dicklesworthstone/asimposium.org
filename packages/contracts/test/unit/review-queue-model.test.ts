...
test("cursor round trips immutable event identity and real timestamp", () => {
  ...
  assert.deepEqual(parseReviewQueueAfter(reviewQueueAfter(createdAt, "E-ABC123")), {
    createdAt,
    eventId: "E-ABC123",
  });
});
for (const invalid of [
  "",
  "0",
  "2026-02-30T00:00:00.000Z|E-1",
  "2026-09-01T00:00:00Z|E-1",
  "2026-09-01T00:00:00.000Z|",
  "2026-09-01T00:00:00.000Z|E-1|extra",
  "2026-09-01T00:00:00.000Z|../private",
  "2026-09-01T00:00:00.000Z|E-1\n",
