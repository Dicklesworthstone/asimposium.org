...
export function generateReviewRequestsSchema(): string {
  return `${JSON.stringify({
    ...
    description: "Author-created, declinable exact-version invitations. Offered and accepted are coordination states, never scientific support or independence tiers. Times are Unix milliseconds. Writes require Idempotency-Key; responses pin the current invitation version.",
