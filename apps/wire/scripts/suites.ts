...
const SUITES: Record<string, Suite> = {
  ...
  integration: {
    ...
    blockedOn:
      "asimposiumorg-p4b (W2.8). `scripts/e2e-s2-krater.sh` exercises local Workerd D1; source/config declare the KraterOutboxDrainer export, alarm handler, binding, and cron nudge. Missing proof is the backup/export retention engine across mounted D1 plus exact-revision staging",
