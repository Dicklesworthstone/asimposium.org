...
const SUITES: Record<string, Suite> = {
  ...
  integration: {
    ...
    blockedOn:
      "asimposiumorg-zr9 (OPS.6). `scripts/e2e-s2-krater.sh` exercises local Workerd D1; source/config declare the KraterOutboxDrainer export, alarm handler, binding, and cron nudge. Missing proof is the deployed Cloudflare cron schedules and drills across mounted D1 plus exact-revision staging",
