  ...
  async (screenMode) => {
    ...
    const child = Bun.spawn(
      [
        ...
        resolve(
          import.meta.dir,
          screenMode === "fellow-pagination"
            ? "fellow-pagination-real-bindings.mjs"
                              ...
                              : screenMode === "stewardship"
                                ...
                                : screenMode === "stoa-surface"
                                  ...
                                  : screenMode === "checkpoints"
                                    ? "checkpoint-signing-real-bindings.mjs"
    ...
    const kind =
      screenMode === "fellow-pagination"
        ? "fellow-pagination-real-bindings"
        : screenMode === "now-pagination"
                        ...
                        : screenMode === "novelty"
                          ...
                          : screenMode === "stewardship"
                            ...
                            : screenMode === "stoa-surface"
                              ...
                              : screenMode === "checkpoints"
                                ? "checkpoint-signing-real-bindings"
                                : screenMode === "identity-lifecycle"
